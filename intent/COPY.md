...
- Header: **Make space for the Word today.**
- Day label: **Day 8 of 28** (dynamic)
- Reading card title: **Matthew 8**
...
- Catch-up card title: **Yesterday's chapter is still open**
...
- Who read strip: **{n} of {m} have read today**
- Streak: **{n} day streak**
- Before October: **Starts Wednesday, October 1.** Get your Connect Group in and your avatar ready.
- After October: **That's Matthew, start to finish.** Thank you for reading with us.
...
- Next stage bar: **{pct}% to {next stage}**
- Roster title: **Who's read today**
- Roster empty: Nobody yet. Be the first one today.
- Leader box title: **Bring someone in**
- Leader box body: Show this code or QR to anyone in the room who isn't in a Connect Group yet.
  They enter it in the app and they're in.
...
- Header: **Rewards**
- Sub: Rewards celebrate consistency, not comparison.
...
- Locked: **{n} more chapters**

## Progress tab

- Header: **Your October**
- Stats: **Chapters** {n}/28. **Coins** {n}. **Streak** {n} days.
- Calendar title: **Matthew · October 2026**
- Leaderboard title: **{Campus} Connect Groups**
- Leaderboard sub: Groups on the same journey. Cheer them on.
...
- Scope line: Showing {section name} and everything under it.
- Columns: Group, Campus, Members, Read today, Progress, Home
